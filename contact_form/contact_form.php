...
// configure
$from = 'system@kanetrussler.com'; // Replace it with Your Hosting Admin email. REQUIRED!
$sendTo = 'business@kanetrussler.com'; // Replace it with Your email. REQUIRED!
...
if(isset($_POST['g-recaptcha-response']) && !empty($_POST['g-recaptcha-response'])):
    ...
    $secret = '6LdFadsnAAAAAHKiz8wJSNea8nbl_w9Clgje-wkk';
